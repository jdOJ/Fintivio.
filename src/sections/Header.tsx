...
export const Header = () => {
  return (
    <header className="sticky top-0 w-full backdrop-blur-sm z-20">
      <div className="py-8">
        <div className="px-4 md:px-8 lg:px-12 w-full">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex gap-6 text-white/60 items-center justify-center">
              <a href="#" className="hover:text-white transition-colors pl-10">Pricing</a>
              <a href="#" className="hover:text-white transition-colors pl-10">About</a>
              <a href="#" className="hover:text-white transition-colors pl-10">Contact</a>
